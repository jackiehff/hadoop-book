...
public class TrackStats extends Record {
    private static final RecordTypeInfo _rio_recTypeInfo;
    private static RecordTypeInfo _rio_rtiFilter;
    private static int[] _rio_rtiFilterFields;

    static {
        _rio_recTypeInfo = new RecordTypeInfo("TrackStats");
        _rio_recTypeInfo.addField("listeners", TypeID.IntTypeID);
        _rio_recTypeInfo.addField("plays", TypeID.IntTypeID);
        _rio_recTypeInfo.addField("scrobbles", TypeID.IntTypeID);
        _rio_recTypeInfo.addField("radioPlays", TypeID.IntTypeID);
        _rio_recTypeInfo.addField("skips", TypeID.IntTypeID);
    }
    ...
    private static void setupRtiFields() {
        ...
        java.util.Iterator<FieldTypeInfo> _rio_itFilter = _rio_rtiFilter.getFieldTypeInfos().iterator();
        _rio_i = 0;
        while (_rio_itFilter.hasNext()) {
            FieldTypeInfo _rio_tInfoFilter = _rio_itFilter.next();
            java.util.Iterator<FieldTypeInfo> _rio_it = _rio_recTypeInfo.getFieldTypeInfos().iterator();
            _rio_j = 1;
    ...
    public void deserialize(final org.apache.hadoop.record.RecordInput _rio_a, final String _rio_tag)
        ...
        for (int _rio_i = 0; _rio_i < _rio_rtiFilter.getFieldTypeInfos().size(); _rio_i++) {
            if (1 == _rio_rtiFilterFields[_rio_i]) {
                ...
                java.util.ArrayList<FieldTypeInfo> typeInfos = (java.util.ArrayList<FieldTypeInfo>) (_rio_rtiFilter.getFieldTypeInfos());
